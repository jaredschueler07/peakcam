...
export default function RunStatus({ store }: { store: StoreApi<HudState> }) {
  ...
  return (
    <dl className="grid grid-cols-2 gap-x-4 rounded-lg border-[1.5px] border-ink bg-cream-50/90 px-3 py-2 font-mono text-[10px] uppercase text-ink shadow-stamp-sm sm:grid-cols-5">
