...
export default function JunctionPrompt({ store }: { store: StoreApi<HudState> }) {
  ...
  return <div className="absolute bottom-48 sm:bottom-24 left-1/2 w-max max-w-[75vw] -translate-x-1/2 rounded-lg border border-ink bg-cream-50/95 px-4 py-2 text-center text-sm text-ink shadow-stamp-sm" data-testid="junction-prompt">
