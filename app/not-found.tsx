...
// Next marks the built-in 404 noindex; keep it explicit now that this is a
// custom page. The metadata export (rather than an inline <meta> tag) is what
// the rest of the app uses, and it keeps a single robots directive in <head>.
